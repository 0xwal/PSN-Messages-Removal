...
namespace PSNLib
{
    public class Friend
    {
        ...
        public bool AddFriend(string onlineId, string message = null)
        {
            var para =  new { requestMessage = message };
            var res = Http.Post(Consts.APIEndpoints.USERS_URL + _context.Profile.OnlineId + $"/friendList/{onlineId}", para, null,
                new
                {
