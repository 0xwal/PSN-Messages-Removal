namespace PSNLib.Models
{
    internal struct Consts
    {
        ...
        internal struct APIEndpoints
        {
            ...
            public const string MESSAGE_URL = "https://us-gmsg.np.community.playstation.net/groupMessaging/v1/messageGroups";
            public const string MESSAGE_THREADS_URL = "https://us-gmsg.np.community.playstation.net/groupMessaging/v1/threads";
            public const string MESSAGE_USERS_URL = "https://us-gmsg.np.community.playstation.net/groupMessaging/v1/users/";
        }
    }
}
